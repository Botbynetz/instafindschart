...
async function loadProductsFromStorage() {
    ...
    if (typeof window.supabase !== 'undefined' && window.supabaseInitialized && typeof ambilProdukSupabase !== 'undefined') {
...
function trackProductClick(productId) {
    ...
    if (product) {
        ...
        if (typeof updateProductClicks !== 'undefined' && window.supabaseInitialized) {
